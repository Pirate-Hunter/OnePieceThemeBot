...
def gban(update: Update, context: CallbackContext):
    ...
    if EVENT_LOGS:
        ...
        send_to_list(bot, WORLD_GOVT + ADMIRALS, log_message, html=True)
        ...
        try:
            ...
            if excp.message in GBAN_ERRORS:
                ...
                if EVENT_LOGS:
                    ...
                    send_to_list(bot, WORLD_GOVT + ADMIRALS,
                                 f"Could not gban due to: {excp.message}")
...
def ungban(update: Update, context: CallbackContext):
    ...
    if EVENT_LOGS:
        ...
        send_to_list(bot, WORLD_GOVT + ADMIRALS, "un-gban complete!")
...
def __user_info__(user_id):
    ...
    if user_id == dispatcher.bot.id:
        return ""
    if int(user_id) in WORLD_GOVT + WARLORDS + REVOLUTIONARIES:
        return ""
    if is_gbanned:
