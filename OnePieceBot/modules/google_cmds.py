    ...
    if reply:
        ...
        try:
            ...
            if HE.reason == 'Not Found':
                ...
                msg.reply_text(
                  """Couldn't access the provided link,
                  The website might have blocked accessing to the website by bot or the website does not existed.""")
                return
...
__help__ = '''
Directly google search pics, short videos, stickers etc. and get the results searched
• `/reverse`*:* Reply to a pic or sticker to get the results from google 
'''
