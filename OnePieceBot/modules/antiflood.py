...
from OnePieceBot import WARLORDS, REVOLUTIONARIES, dispatcher
...
from OnePieceBot.modules.sql import antiflood_sql as sql
...
from OnePieceBot.modules.helper_funcs.chat_status import is_user_admin, user_admin, can_restrict
...
def check_flood(update, context) -> str:
    ...
    if (is_user_admin(chat, user.id) or user.id in REVOLUTIONARIES or user.id in WARLORDS):
